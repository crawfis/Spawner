...
namespace CrawfisSoftware.Spawner
{
    ...
    /// </summary>
    public class SpawnerAndModifier : IPrefabModifierAsync, ISpawner
    {
        ...
        public SpawnerAndModifier(IPrefabGeneratorAsync prefabSelector, IList<IPrefabModifierAsync> prefabModifiers)
        {
