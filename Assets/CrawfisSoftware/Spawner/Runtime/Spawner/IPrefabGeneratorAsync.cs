...
namespace CrawfisSoftware.Spawner
{
    ...
    public interface IPrefabGeneratorAsync
    {
        ...
        /// <param name="counter">A counter from the spawner.</param>
        /// <returns>A game object.</returns>
        System.Threading.Tasks.Task<GameObject> CreateAsync(Vector3 position, SpawnerAndModifier spawner, int counter);
    }
}